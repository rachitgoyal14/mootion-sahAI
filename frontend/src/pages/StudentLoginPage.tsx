          ...
          <div className="flex flex-col gap-3 md:gap-4 flex-1 justify-center relative mt-2">
            ...
            <div className="relative w-full">
              <input 
                ...
                disabled={isLoading}
                className="w-full px-6 py-2 md:py-3 text-[13px] sm:text-sm md:text-base bg-transparent border border-[#1800ad] rounded-full text-center text-[#2c2c2c] placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-[#1800ad] pr-10"
              />
              <button
                type="button"
                onClick={() => setShowPassword(p => !p)}
                tabIndex={-1}
                className="absolute right-3 top-1/2 -translate-y-1/2 text-[#1800ad]/50 hover:text-[#1800ad] transition-colors"
              >
                {showPassword ? (
            ...
            <button 
              type="submit"
              disabled={isLoading || !studentId.trim() || password.length < 8}
